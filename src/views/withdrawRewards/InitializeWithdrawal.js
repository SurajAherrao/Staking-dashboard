  ...
  return (
    <form onSubmit={initiateWithdraw} className={clsx(classes.root, className)} {...rest}>
      ...
      <Box mt={2}>
        ...
        Please confirm the withdrawal finalization by sending a Web3 wallet transaction. Once the transaction is processed, your rewards will be available in your wallet.
        </Typography>
      </Box>
      
      <Box mt={6} display="flex">
        {onBack && (
          <Button id="initWithdrawalRewardsBack" onClick={onBack} size="large">
            Previous
          </Button>
        )}
        <Box flexGrow={1} />
        <Button
          id="initWithdrawalRewardsNext"
          color="secondary"
