...
const Confirm = ({ className, onBack, onNext, ...rest }) => {
      ...
      >
        <Grid item container direction="column" justifyContent="flex-start">
          ...
          <Box mt={2}>
            <Typography variant="subtitle1" color="textSecondary">
              Please confirm to <strong>Stake</strong>. This transaction you
              make will finalize the staking.
            </Typography>
          </Box>
          <Box mt={2}>
            <Typography variant="subtitle1" color="textSecondary">
              You are about to stake:<strong> {staking.stakingValue.toString()} SJ</strong>
            </Typography>
          </Box>
          {error && (
            <Box mt={2}>
        ...
        <Grid item container direction="column" justifyContent="flex-end">
          <Box mt={6} display="flex">
            {onBack && (
              <Button id="stakeRewardsConfirmBack" onClick={onBack} size="large">
                Previous
              </Button>
            )}
            <Box flexGrow={1} />
